...
function setupRPC(nuxt, options) {
    ...
    if (rpcHost) {
      for (const [fnName, handler] of Object.entries(functions)) {
        if (typeof handler === "function") {
          rpcHost.register({ name: `${namespace}:${fnName}`, handler });
        }
      }
    }
    return {
  ...
  const ctx = {
    ...
    openInEditorHooks: [],
    /** @deprecated Auth is now handled by Vite DevTools */
    async ensureDevAuthToken(_token) {
