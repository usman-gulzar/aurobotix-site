 ...
 */
function forceBundleNitropack(id) {
  if (!id) return false;
...
function stripNitropackRuntimeExternal(rollupOptions) {
  ...
  if (typeof ext === 'function') {
    const prev = ext;
    rollupOptions.external = (id, importer, isResolved) => {
...
function patchSsrRollupExternals(config) {
